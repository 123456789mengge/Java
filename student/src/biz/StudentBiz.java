...
public class StudentBiz {
	 ...
	 * 用户注册，业务逻辑实现
	 */
	public void register(String studentNo,String studentName, String studentGender, 
          int studentAge,String studentDepartment,String firstPassword, 
...
System.out.println(student.getStudentName()+"注册成功！");
save();
MainUI.show();
}else {
MainUI.show();
